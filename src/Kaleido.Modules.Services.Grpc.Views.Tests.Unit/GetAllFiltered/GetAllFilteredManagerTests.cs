...
namespace Kaleido.Modules.Services.Grpc.Views.Tests.Unit.GetAllByName
{
    public class GetAllFilteredManagerTests
    {
        ...
        public GetAllFilteredManagerTests()
        {
            ...
            _sut = new GetAllFilteredManager(_viewLifecycleHandlerMock.Object, _categoryViewLinkLifecycleHandlerMock.Object);
        }
        ...
        public async Task GetAllAsync_ReturnsViewsAndLinks_WhenDataExists()
        {
            ...
            _viewLifecycleHandlerMock
                .Setup(x => x.FindAllAsync(
                    It.IsAny<Expression<Func<ViewEntity, bool>>>(),
                    It.IsAny<Expression<Func<ViewRevisionEntity, bool>>>(),
                    It.IsAny<Guid?>(),
            ...
            Assert.Equal(viewEntities.First(), result.First().View);
            Assert.Equal(categoryViewLinkResults, result.First().CategoryViewLinks);
        }
